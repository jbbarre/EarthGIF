...
#glacier="upernavik"
#full_name="Upernavik Isstrøm"

glacier="upernavik_s"
full_name="Upernavik Isstrøm South"
...
if __name__ == '__main__':
    ...
    datetimeRange=[]
    for t in range (2017,2022):
        datetimeRange.append(str(t)+"-08-02/"+str(t)+"-09-30")

    sentinelSTAC = pystac_client.Client.open('https://planetarycomputer.microsoft.com/api/stac/v1')
    ...
    for dt in datetimeRange:    
        ...
        stack = stackstac.stack(items,bounds_latlon=bbox, epsg = 32620, resolution=10)
        ...
        composites = valid.sel(band=["B04", "B03", "B02"]).resample(time="W").median("time")
