...
if __name__ == '__main__':
    ...
    cluster.scale(jobs=15)  # ask for 10 jobs
    ...
    for dt in datetimeRange:    
        search = (
            ...
            .search(
                bbox=bbox,
                query =  {"eo:cloud_cover":{"lt":setting['cloud_cover']}},
                datetime = dt, 
        ...
        composites = valid.sel(band=["B04", "B03", "B02"]).resample(time="Q").median("time")
