...
if __name__ == '__main__':
    ...
    for t in range (2021,2022):
        datetimeRange.append(str(t)+"-12-01/"+str(t)+"-12-30")

    modisSTAC = pystac_client.Client.open('https://planetarycomputer.microsoft.com/api/stac/v1')
    ...
    for dt in datetimeRange:    
        ...
        composites = stack.sel(band=["sur_refl_b01", "sur_refl_b04", "sur_refl_b03"]).resample(time="W").median("time")
