...
if __name__ == '__main__':
    ...
    for t in range (2021,2022):
        datetimeRange.append(str(t)+"-01-01/"+str(t)+"-01-30")

    sentinelSTAC = pystac_client.Client.open('https://earth-search.aws.element84.com/v0')
    ...
    for dt in datetimeRange:    
        ...
        composites = valid.sel(band=["B04", "B03", "B02"]).resample(time="T").median("time")
